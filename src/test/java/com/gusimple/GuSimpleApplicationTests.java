...
@SpringBootTest(classes = GuSimpleApplicationTests.class,webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class GuSimpleApplicationTests {
    private static final Logger log = LoggerFactory.getLogger(GuSimpleApplicationTests.class);
    @Autowired
